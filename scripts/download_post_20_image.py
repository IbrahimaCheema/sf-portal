...
with open("scripts/post_20_meta.json", "r", encoding="utf-8") as f:
    meta = json.load(f)
...
temp_webp = os.path.join(out_dir, "temp_ig_post_20.webp")
out_jpg = os.path.join(out_dir, "hd_ig_post_20.jpg")
...
try:
    ...
    with open(temp_webp, "wb") as f:
        f.write(data)
    print("Downloaded temp_ig_post_20.webp, size:", len(data))
