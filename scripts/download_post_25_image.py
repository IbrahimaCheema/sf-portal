...
with open("scripts/post_25_meta.json", "r", encoding="utf-8") as f:
    meta = json.load(f)
...
temp_file = os.path.join(out_dir, "temp_ig_post_25_raw")
out_jpg = os.path.join(out_dir, "hd_ig_post_25.jpg")
