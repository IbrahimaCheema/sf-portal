...
url = 'https://www.instagram.com/p/Db2GdcxDeuF/embed/captioned/'
...
try:
    ...
    with open("scripts/db2g_embed.html", "w", encoding="utf-8") as f:
        f.write(content)
    
    print("Saved db2g_embed.html, length:", len(content))
