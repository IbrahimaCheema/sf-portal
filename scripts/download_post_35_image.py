...
with open("scripts/post_35_meta.json", "r", encoding="utf-8") as f:
    meta = json.load(f)
...
temp_file = os.path.join(out_dir, "temp_ig_post_35_raw")
out_jpg = os.path.join(out_dir, "hd_ig_post_35.jpg")
