...
meta = {
    "url": f"https://www.instagram.com/p/{shortcode}/?utm_source=ig_web_copy_link&igsi=MzRlODBiNWFlZA==",
...
with open("scripts/post_31_meta.json", "w", encoding="utf-8") as f:
    json.dump(meta, f, indent=2, ensure_ascii=False)

print("\nSaved metadata to scripts/post_31_meta.json")
